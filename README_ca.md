# TA05-MizhquiriTrishan-ASIXc1D -- Portafoli Professional
...
- **Proyectos**: Llista completa de projectes tècnics relacionats amb:
  - Automatització (Bash, PowerShell, Python)
  - Monitorització de xarxa (NetFlow, Wireshark, Nmap)
  - Enduriment de sistemes (SSH, Apache, iptables, polítiques de contrasenyes)
  - Gestió de servidors (Ubuntu Server, Windows Server)
  - Còpies de seguretat i integritat (GPG, hash SHA256, cron, Robocopy)
- **Sobre mi**: Breu biografia professional i filosofia de treball.
...
- **Efectes visuals**: Partícules animades en fons (canvas)
- **Icones**: Font Awesome
